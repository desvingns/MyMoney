...
class ThemeSettingsViewModelTest {
    ...
    @Test
    fun `initial state reflects the persisted system theme`() = runTest {
    ...
    @Test
    fun `initial state reflects the persisted light theme`() = runTest {
    ...
    @Test
    fun `initial state reflects the persisted dark theme`() = runTest {
    ...
    @Test
    fun `selecting Light persists the exact stored value light`() = runTest {
        val viewModel = buildViewModel(stored = "system")
    ...
    @Test
    fun `selecting Dark persists the exact stored value dark`() = runTest {
        val viewModel = buildViewModel(stored = "system")
    ...
    @Test
    fun `selecting a mode updates the state as the settings flow re-emits`() = runTest {
        val viewModel = buildViewModel(stored = "system")
    ...
    @Test
    fun `persisting a mode leaves the other settings fields untouched`() = runTest {

...
description: Runs Gradle verification tasks for MyMoney (tests, detekt, optional Roborazzi screenshot verify) and returns structured pass/fail JSON. Never reads or modifies source files. Minimal and fast.
tools: Bash
---

...
sealed interface TransactionDetailEvent {
    data class KeypadDigit(val d: Int) : TransactionDetailEvent
    data class KeypadOperator(val op: Operator) : TransactionDetailEvent
    ...
    data class NoteChanged(val text: String) : TransactionDetailEvent
    data class DateChanged(val date: LocalDate) : TransactionDetailEvent
    ...
    data class UndoDeleteClicked(val id: Long) : TransactionDetailEvent

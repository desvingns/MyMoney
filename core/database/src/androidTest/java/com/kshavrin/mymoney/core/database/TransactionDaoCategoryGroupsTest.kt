...
class TransactionDaoCategoryGroupsTest {
    ...
    private fun category(name: String, kind: String) = CategoryEntity(
        name = name,
        kind = kind,
    ...
    @Test
    fun getCategoryGroups_sums_amount_and_counts_rows_per_category() = runTest {
    ...
    @Test
    fun getCategoryGroups_includes_both_income_and_expense_with_correct_kind() = runTest {
    ...
    @Test
    fun getCategoryGroups_orders_by_total_desc() = runTest {
        insert(categoryId = categoryFood, amount = 10.0, occurredAt = 1 * day)
    ...
    @Test
    fun getCategoryGroups_excludes_soft_deleted_rows_from_total_and_count() = runTest {
    ...
    @Test
    fun getCategoryGroups_excludes_transfers() = runTest {
        insert(categoryId = categoryFood, amount = 10.0, occurredAt = 1 * day, kind = "expense")
        insert(
            categoryId = null,
            amount = 25.0,
    ...
    @Test
    fun getCategoryGroups_filters_by_account_and_period() = runTest {
    ...
    @Test
    fun getCategoryGroups_returns_empty_for_empty_period() = runTest {

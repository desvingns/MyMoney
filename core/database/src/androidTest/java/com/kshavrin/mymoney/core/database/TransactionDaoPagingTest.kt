...
class TransactionDaoPagingTest {
    ...
    fun setUp() = runTest {
        ...
        currencyId = db.currencyDao().upsert(
    ...
    @Test
    fun pagedByPeriod_filters_by_account() = runTest {
    ...
    @Test
    fun pagedByPeriod_filters_by_occurred_at_between_from_and_to() = runTest {
    ...
    @Test
    fun pagedByPeriod_includes_boundary_values_inclusive() = runTest {
    ...
    @Test
    fun pagedByPeriod_excludes_soft_deleted_rows() = runTest {
    ...
    @Test
    fun pagedByPeriod_null_category_returns_all_including_transfers_with_null_category() = runTest {
    ...
    @Test
    fun pagedByPeriod_nonnull_category_returns_only_that_category() = runTest {
    ...
    @Test
    fun pagedByPeriod_orders_by_occurred_at_desc_then_created_at_desc() = runTest {
    ...
    @Test
    fun pagedByPeriod_returns_empty_page_when_nothing_matches() = runTest {
    ...
    @Test
    fun restore_flips_is_deleted_back_to_zero_and_updates_updated_at() = runTest {
    ...
    @Test
    fun restore_makes_the_row_visible_to_pagedByPeriod_again() = runTest {
        val id = insert(accountId = accountA, occurredAt = 5 * day, isDeleted = true)

        val beforeRestore = loadAll(
            db.transactionDao().pagedByPeriod(accountA, categoryId = null, from = 0L, to = 10 * day),
        )

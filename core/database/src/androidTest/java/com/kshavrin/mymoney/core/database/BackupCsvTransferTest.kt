...
class BackupCsvTransferTest {
    ...
    @Test
    fun export_with_transfers_does_not_throw_and_file_contains_all_row_kinds() =
        runTest {
    ...
    @Test
    fun legacy_9_column_csv_imports_expense_and_income_correctly() =
        runTest {
            val currencyId = seedCurrency()
    ...
    @Test
    fun transfer_row_in_legacy_9_column_file_is_rejected_with_an_error() =
        runTest {
            val currencyId = seedCurrency()
            seedAccount("Наличные", currencyId, sortOrder = 0)

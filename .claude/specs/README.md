...
> In MyMoney this board is for **ad-hoc `--feature` epics** (e.g. a multi-screen redesign). It is
> separate from the 15-phase TDD roadmap under `docs/implementation_plan/` — use the phase plan
> (`PROGRESS.md` + `phases/PHASE_NN_*.md`) for the planned build, the board for everything else.

...
sealed interface CurrenciesListEvent {
    ...
    data class ItemClicked(val id: Long) : CurrenciesListEvent
    data class ActiveToggled(val id: Long, val active: Boolean) : CurrenciesListEvent
...
sealed interface CurrenciesListAction {
    ...
    data class NavigateEdit(val id: Long) : CurrenciesListAction

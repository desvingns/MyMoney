...
class BalanceCalculatorTest {
    ...
    @Test
    fun `forAccounts aggregates only active accounts in the selected currency`() = runTest {
        ...
        assertEquals(0, BigDecimal("40.00").compareTo(snapshot.byCategory.single { it.categoryId == 100L }.total.amount))

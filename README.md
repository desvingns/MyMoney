...
Radar pull requests use the `dependencies` and `dependency-radar` labels. The latter skips only the emulator-heavy connected-test CI job; JVM checks still run.

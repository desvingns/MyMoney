...
sealed interface SearchEvent {
    ...
    data class SuggestionClicked(val query: String) : SearchEvent
    data class VoiceResult(val text: String) : SearchEvent
    data class ResultClicked(val transactionId: Long) : SearchEvent

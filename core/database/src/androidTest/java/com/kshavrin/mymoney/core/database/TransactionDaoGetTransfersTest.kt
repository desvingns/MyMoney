...
class TransactionDaoGetTransfersTest {
    ...
    @Test
    fun getTransfers_returns_only_kind_transfer_rows() = runTest {
    ...
    @Test
    fun getTransfers_excludes_soft_deleted_transfers() = runTest {
    ...
    @Test
    fun getTransfers_filters_by_period() = runTest {
    ...
    @Test
    fun getTransfers_with_null_accountId_returns_all_transfers_in_period() = runTest {
        insertTransfer(fromAccountId = accountCash, toAccountId = accountCard)
    ...
    @Test
    fun getTransfers_with_accountId_matches_source_account() = runTest {
        insertTransfer(fromAccountId = accountCash, toAccountId = accountCard)
    ...
    @Test
    fun getTransfers_with_accountId_matches_recipient_account() = runTest {
        insertTransfer(fromAccountId = accountCash, toAccountId = accountCard)
        insertTransfer(fromAccountId = accountSavings, toAccountId = accountCard)
    ...
    @Test
    fun getTransfers_populates_fromAccountName_and_toAccountName_via_join() = runTest {
    ...
    @Test
    fun getTransfers_returns_empty_list_when_no_transfers_in_period() = runTest {
    ...
    @Test
    fun getTransfers_orders_by_occurred_at_desc() = runTest {

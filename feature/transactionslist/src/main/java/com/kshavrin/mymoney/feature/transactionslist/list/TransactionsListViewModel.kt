...
class TransactionsListViewModel
    ...
    constructor(
        ...
        private suspend fun applyLoadedState() {
            ...
            val groups =
                if (requestedCategoryId != null && filteredGroups.isEmpty()) {
            ...
            _state.value =
                _state.value.copy(
                    ...
                    expandedCategoryIds =
                        activeCategoryId?.let(::setOf) ?: _state.value.expandedCategoryIds.filterTo(linkedSetOf()) { expandedId ->
        ...
        private suspend fun resolveSelection(): RecordsSelection {
            ...
            val currency =
                currencyId?.let { id -> currencyRepository.findById(id) }

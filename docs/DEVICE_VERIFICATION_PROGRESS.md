...
| 2026-05-27 | S03 keypad/note controls green, 6/6 | `TransferScreenUiTest` confirms Back, initial disabled Save, amount-press keypad reveal/digit, revealed backspace, note-focus dismissal, and note input event dispatch on `Pixel_5_API_34`; the complete BR-23 fix is in `9dea4d7`. |
...
| 2 | Transaction forms S07/S03/S09/S27, including AS-4 and AS-6 paths | In progress | S07 stable controls 7/7; S03 keypad/note controls 6/6 green 2026-05-27; S03 dropdown/rate/date/save-valid controls, S09/S27, AS-4/AS-6, and error seams pending |
...
| S03 Transfer | back, account pickers, keypad, rate/change, save | Partial green: Back, initial disabled Save, keypad reveal/digit/backspace, note focus/input 6/6 | Pending | Pending | `TransferScreenUiTest` 6/6 green 2026-05-27; BR-23 focus-dismissal defect fixed in `9dea4d7` and re-reviewed green; account pickers/rate/date/save-valid controls and AS-6/AS-7 E2E pending |
...
- Continued S03 form coverage in `7d70c4d`, `35fa5df`, `b8924e2`,
  `17b2117`, `9e624bf`, `9dea4d7`, and `8525ac2`: Back dispatches
  ...
  `TransferEvent.NoteChanged`. Native review caught that the first
  ...
  `TransferScreenUiTest` passed `6/6`, and S06/S07 shared-component

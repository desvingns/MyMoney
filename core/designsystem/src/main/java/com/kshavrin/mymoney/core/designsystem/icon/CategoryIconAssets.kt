...
@DrawableRes
fun categoryNeonIconRes(iconKey: String): Int =
    categoryNeonIconResOrNull(iconKey) ?: R.drawable.category_neon_tag

@DrawableRes
fun categoryNeonIconResOrNull(iconKey: String): Int? =
    categoryNeonIconAssets[iconKey]

private val categoryNeonIconAssets: Map<String, Int> =
    mapOf(

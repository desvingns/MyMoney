...
- Expense flow: `build/visual-check/a11y-2026-07-16-manual-pass/06-add-expense-calculator-initial.png`, `build/visual-check/a11y-2026-07-16-manual-pass/07-calculator-12-5.png`, `build/visual-check/a11y-2026-07-16-manual-pass/08-category-picker.png`, `build/visual-check/a11y-2026-07-16-manual-pass/09-dashboard-after-expense.png`.
- TalkBack/keyboard probes: `build/visual-check/a11y-2026-07-16-manual-pass/10-talkback-swipe-dashboard.png`, `build/visual-check/a11y-2026-07-16-manual-pass/11-talkback-tab-dashboard.png`, `build/visual-check/a11y-2026-07-16-manual-pass/12-talkback-enter-dashboard.png`, `build/visual-check/a11y-2026-07-16-manual-pass/13-onboarding-before-tab.png`, `build/visual-check/a11y-2026-07-16-manual-pass/14-onboarding-after-tab.png`, `build/visual-check/a11y-2026-07-16-manual-pass/15-onboarding-after-enter.png`, `build/visual-check/a11y-2026-07-16-manual-pass/16-calculator-before-tab.png`, `build/visual-check/a11y-2026-07-16-manual-pass/17-calculator-after-tab.png`, `build/visual-check/a11y-2026-07-16-manual-pass/18-calculator-after-enter.png`. Matching `.xml` UI hierarchy dumps are beside each PNG.
